...
Actual Phase 1 offline measurements and image IDs are recorded in
[phase-1-baseline.md](../evidence/phase-1-baseline.md). These are fabricated smoke results,
not CCTD preparation or paid Anthropic results.
